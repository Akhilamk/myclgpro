...
<html lang="en">
  ...
  <body>
   <div class="container-fluid">
     <!-- <top section> -->
       <div class="row">
           <div class="col-lg-4 col-sm-12 col-xs-12 col-md-12" style="height: 90px; background-color: white;"><img src="{{url('images/brillions.png')}}" style="height:60px; margin-top: 10px; margin-left: 35px; " alt=""><img src="grad.jpg" alt="" style="height: 40px;"></div>
