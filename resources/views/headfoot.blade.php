        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar" style="background-image: linear-gradient(rgb(6, 6, 51),rgb(7, 7, 58));">
          ...
          <li class="nav-item dropdown active">
           ...
           <footer >
             ...
             <div class="row">
               <div class="col-lg-4 col-sm-12 col-xs-12 col-md-12"  style="height: 300px; background-color: rgb(68, 62, 62); align-content: center;">
               ...
               <div class="col-lg-4 col-sm-12 col-xs-12 col-md-12"  style="height: 300px; background-color: rgb(68, 62, 62);">
